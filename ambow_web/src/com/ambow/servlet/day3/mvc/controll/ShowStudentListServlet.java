...
public class ShowStudentListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		showStudent(response,studentList);
	}

	private void showStudent(HttpServletResponse response, List studentList) throws IOException {
		...
		out.println("</head>");
		out.println("<body>");
		out.println("<h2 align=\"center\">Student List USE Show Student view</h2>");
		out.println("<hr/>");
