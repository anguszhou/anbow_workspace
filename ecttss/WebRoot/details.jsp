...
<div id="wrap">
       ...
       <div class="center_content">
        ...
        <div class="right_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>商品详细信息</div>
        	...
        	<div class="feat_prod_box_details">
                ...
                <div class="prod_det_box">
                    ...
                    <div class="price"><strong>名称:</strong> <span class="red">${ productdetails.name }</span></div>
                    <div class="price"><strong>型号:</strong> <span class="red">D630</span></div>                 
                    <div class="price"><strong>价格:</strong> <span class="red">5600 $</span></div>
                    <div class="price"><strong>机型:</strong> <span class="red">商用机</span></div>
                     <div class="price"><strong>CPU:</strong> <span class="red">酷睿i7</span></div>
                      <div class="price"><strong>显卡:</strong> <span class="red">GT220</span></div>
                    ...
                    <div class="price"><strong>硬盘:</strong> <span class="red">250G</span></div>
                     <a href="${pageContext.request.contextPath}/addCart.do?pid=${ productdetails.id }" class="checkout">加入购物车 &gt;</a>
                    <div class="clear"></div>
                    </div>
