				...
				<div >
					...
					<div class="feat_prod_box_details" >
						...
						<div  class="contact_form"  style="margin-left:150px;width:65%;">
							...
							<form style="padding-left:5%;" action="${pageContext.request.contextPath}/updateUser.do" method="post">
								<table>
									<tr>
										<td>用户名：</td>
										<td>
									...
									<tr>
										<td>密码：</td>
										<td><input name="password" value="${ user.passwd }"/><font color="red">*用户名可以由6-20个字母或数字组成</font></td>
									</tr>
									<tr>
										<td>确认密码：</td>
