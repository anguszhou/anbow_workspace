...
<div id="wrap">
       ...
       <div class="center_content">
        ...
        <div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" />商品列表<br /></span></div>
        	...
        	<div class="feat_prod_box">
                ...
                <!--<span class="special_icon"><img src="images/special_icon.gif" alt="" title="" /></span>  -->
                    ...
                    <a href="${pageContext.request.contextPath}/findById.do?pid=${ product.id }" class="more">- 详细信息 -</a>
                    <div class="clear"></div>
                    </div>
