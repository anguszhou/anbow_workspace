      ...
      <table class="cart_table">
            	...
            	<tr>
                    ...
                    <td><input type="button" value="返回" onclick="history.go(-1)"/>
                       <input type="button" value="保存修改" onclick="modifyCart(this.form, ${ orderline.value.product.id }, document.getElementById(${ status.count }).value)"  /> 
                    	<input type="button" value="取消商品" onclick="deleteProduct(this.form, ${ orderline.value.product.id })"  /> 
					</td>             
                </tr>
                 </c:forEach>     
            ...
            <center>             
					<input type="button" onclick="javascript:window.location='${pageContext.request.contextPath}/deleteOrderLine.do?methodName=deleteCart';" value="清空购物车"/>  
            </center>
            </form>
            <a href="${pageContext.request.contextPath}/ShowProductServlet.func" class="continue">&lt;继续购物</a>
