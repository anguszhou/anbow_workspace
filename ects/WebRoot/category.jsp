...
<div id="wrap">
       ...
       <div class="center_content">
        ...
        <div class="right_content">
        	<div class="crumb_nav">
            <a href="index.html">主页</a> &gt;&gt;商品</div>
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>商品种类</div>
           
           <div class="new_products">
           <c:forEach items="${collection}" var="product" varStatus="status">
                    <div class="new_prod_box">
                        <a href="details.html">${product.name}</a>
                        <div class="new_prod_bg">
                        <span class="new_icon"><img src="images/new_icon.gif" alt="" title="" /></span>
                        <a href="/ects/ShowProductServlet1.func?productId=${product.id}"><img src="images/thumb1.gif" alt="" title="" class="thumb" border="0" /></a>
                        </div>           
                    </div> 
            ...
            <span class="disabled"></span><span class="current">1</span><a href="#?page=2">2</a><a href="#?page=3">3</a>…<a href="#?page=199">10</a><a href="#?page=200">11</a><a href="#?page=2"/>
            </div>  
