...
public class ContcatInfo  implements  Serializable{
	...
	private   Integer  id;//用户关联信息表主键ID
    private   String  street1;//街道地址1
    private   String  street2;//街道地址2
    private   String  city;//城市
    private   String  zip;//邮编
    private   String  email;//邮箱
    private   String  homePhone;//家用电话
    private   String  cellPhone;//随身电话
    private   String  officePhone;//办公电话
    
    private   User  user;//关联属性用户
    private   Country  country;//关联属性国家
    private   Province province;//关联性性省份
